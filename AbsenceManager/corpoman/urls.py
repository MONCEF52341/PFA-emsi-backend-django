...
urlpatterns = [
    ...
    path('api/collaborateurs/<int:pk>/', CollaborateurRetrieveUpdateDestroyAPIView.as_view(), name='collaborateur-retrieve-update-destroy'),
    path('api/demandeabsence/', DemandeAbsenceListCreateAPIView.as_view(), name='demandeabsence-list-create'),
    path('api/demandeabsence/<int:pk>/', DemandeAbsenceRetrieveUpdateDestroyAPIView.as_view(), name='demandeabsence-retrieve-update-destroy'),
    ...
    path('api/entitejuridique/<int:pk>/', EntiteJuridiqueRetrieveUpdateDestroyAPIView.as_view(), name='entitejuridique-retrieve-update-destroy'),
    path('api/lieutravail/', LieuTravailListCreateAPIView.as_view(), name='lieutravail-list-create'),
    path('api/lieutravail/<int:pk>/', LieuTravailRetrieveUpdateDestroyAPIView.as_view(), name='lieutravail-retrieve-update-destroy'),
    ...
    path('api/contrat/<int:pk>/', ContratRetrieveUpdateDestroyAPIView.as_view(), name='contrat-retrieve-update-destroy'),
    path('api/heurescontractuelles/', HeuresContractuellesListCreateAPIView.as_view(), name='heurescontractuelles-list-create'),
    path('api/heurescontractuelles/<int:pk>/', HeuresContractuellesRetrieveUpdateDestroyAPIView.as_view(), name='heurescontractuelles-retrieve-update-destroy'),
    path('api/politiqueabsences/', PolitiqueAbsencesListCreateAPIView.as_view(), name='politiqueabsences-list-create'),
    path('api/politiqueabsences/<int:pk>/', PolitiqueAbsencesRetrieveUpdateDestroyAPIView.as_view(), name='politiqueabsences-retrieve-update-destroy'),
    path('api/compteurabsences/', CompteurAbsencesListCreateAPIView.as_view(), name='compteurabsences-list-create'),
    path('api/compteurabsences/<int:pk>/', CompteurAbsencesRetrieveUpdateDestroyAPIView.as_view(), name='compteurabsences-retrieve-update-destroy'),
    path('api/typeabsence/', TypeAbsenceListCreateAPIView.as_view(), name='typeabsence-list-create'),
    path('api/typeabsence/<int:pk>/', TypeAbsenceRetrieveUpdateDestroyAPIView.as_view(), name='typeabsence-retrieve-update-destroy'),
    ...
    path('api/configuration/<int:pk>/', ConfigurationRetrieveUpdateDestroyAPIView.as_view(), name='configuration-retrieve-update-destroy'),
