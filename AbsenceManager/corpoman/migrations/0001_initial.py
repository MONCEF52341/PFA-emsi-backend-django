    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nom', models.CharField(max_length=100, verbose_name='Nom')),
                ('avatar', models.ImageField(blank=True, null=True, upload_to='avatars/', validators=[corpoman.validators.validate_avatar])),
                ('matricule', models.CharField(default=corpoman.utils.generate_matricule, max_length=11, unique=True, verbose_name='Matricule')),
